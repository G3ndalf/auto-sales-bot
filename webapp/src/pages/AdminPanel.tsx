...
export default function AdminPanel() {
  ...
  /** Редактирование объявления — переход на существующую страницу EditCarAd/EditPlateAd с ?admin=true */
  const handleEditClick = (type: 'car' | 'plate', ad: { id: number }) => {
    navigate(`/${type}/${ad.id}/edit?admin=true`)
  }
