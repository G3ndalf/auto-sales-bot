...
/**
 * PlateAdDetail — детальная страница объявления номера.
 *
 * Фичи галереи:
 ...
 *
 * Контакт-кнопки:
 *  - "💬 Написать" — deep link на бота (msg_plate_{id})
 ...
 *  - Объединить дублирующийся код с CarAdDetail.tsx
 */
...
export default function PlateAdDetail() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: `${ad.plate_number}, ${formatPrice(ad.price)} — Авто КБР`,
    ...
    <div className="detail-page">
      ...
      <div className="detail-header">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
          <h1 className="plate-title" style={{ margin: 0, flex: 1 }}>{ad.plate_number}</h1>
      ...
      {/*
        ...
        "Написать" — deep link на бота с командой msg_plate_{id}
      */}
      ...
      {fullscreen && photos.length > 0 && (
        ...
        >
          ...
          <img
            ...
            alt={`${ad.plate_number} — фото ${fullscreenIndex + 1}`}
            style={fsImgStyle}
            draggable={false}
          />
